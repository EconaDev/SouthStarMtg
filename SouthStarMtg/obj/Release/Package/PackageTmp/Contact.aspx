<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="Contact.aspx.cs" Inherits="SouthStarMtg.Contact" %>

<asp:Content ID="content" ContentPlaceHolderID="Content" runat="server">
    <div style="width: 956px; height: 480px; background-image: url('Images/location.jpg');">
        <div class="content-sub">
            <div class="contact">
                ...
                <br />
                <div class="intro" id="contactintro" runat="server">
                    Please fill out the following form to initiate contact with SouthStar Mortgage Company.
                    Your information will be sent to SouthStar Mortgage Company. A representative from
                    SouthStar Mortgage Company will contact you by telephone or email.</div>
                <br />
                        ...
                        <div class="row1col1">
                            ...
                            <div class="row1col1cel1bottom">
                                ...
                                <asp:RequiredFieldValidator ID="rfvFirstName" runat="server" ControlToValidate="txtFirstName"
                                    Display="Dynamic" EnableViewState="False" ErrorMessage="*" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="row1col2">
                    ...
                    <div class="row2">
                        <div class="row2col1">
                            <div class="row2col1cel1top">
                                <asp:Label ID="lblStreetAddress" CssClass="label" runat="server" Text="Street Address"></asp:Label>
                            </div>
                    ...
                    <div class="row3">
                        <div class="row3col1">
                            <div class="row3col1cel1top">
                                <asp:Label ID="lblPrimaryPhone" CssClass="label" runat="server" Text="Primary Phone"></asp:Label>
                            </div>
                        ...
                        <div class="row3col2">
                            <div class="row3col2cel1top">
                                <asp:Label ID="lblSecondaryPhone" CssClass="label" runat="server" Text="Secondary Phone"></asp:Label>
                            </div>
                        ...
                        <div class="row3col3">
                            <div class="row3col3cel1top">
                                <asp:Label ID="lblBestTime" CssClass="label" runat="server" Text="Best Time to Call"></asp:Label>
                            </div>
                    ...
                    <div class="row4">
                        <div class="row4col2">
                            ...
                            <div class="row4col2cel1bottom">
                                <asp:TextBox ID="txtComments" CssClass="input" TextMode="MultiLine" Width="550px"
